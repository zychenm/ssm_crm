    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	...
        	if (page.getPage() > 1) {
                ...
                String preUrl = append(url, "pageNum", page.getPage() - 1);
                preUrl = append(preUrl, "pageSize", page.getSize());
            ...
            for(int i=1; i <= number && indexPage <= pageCount; indexPage++, i++) {
                ...
                String pageUrl  = append(url, "pageNum", indexPage);
                pageUrl = append(pageUrl, "pageSize", page.getSize());
                writer.print("<li><a href=\"" + pageUrl + "\">"+ indexPage +"</a></li>");
            }
            //显示“下一页”按钮
            if (page.getPage() < pageCount) {
                String nextUrl  = append(url, "pageNum", page.getPage() + 1);
                nextUrl = append(nextUrl, "pageSize", page.getSize());

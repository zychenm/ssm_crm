...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/listCustomer" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/customer/listCustomer" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				type:"get",
				url:"<%=basePath%>customer/editCustomerById",
				data:{"custId":id},
		...
		function updateCustomer() {
			//serialize()方法是将提交的表单所有参数序列alert弹框显示
			alert($("#edit_customer_form").serialize());
			$.post("<%=basePath%>customer/editCustomer",$("#edit_customer_form").serialize(),function(data){
				alert("客户信息更新成功！");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("<%=basePath%>customer/deleteCustomer",{"custId":id},function(data){
					alert("客户删除更新成功！");
					window.location.reload();
				});
			}
